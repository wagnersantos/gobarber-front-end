...
import { parseISO, isToday, format, isAfter, formatDistance } from 'date-fns';
...
const Dashboard: React.FC = () => {
  ...
  const firstSpanDate = useMemo(() => {
    return isToday(selectedDate)
      ? 'Hoje'
      : `Daqui há ${formatDistance(selectedDate, new Date(), {
          locale: ptBR,
        }).replace('cerca de', '')}`;
  }, [selectedDate]);
